...
// inline editing). Navigation itself lives in `lib/database/useOpenNote.ts`
// (task-17 fix round, finding 1) — Board and Gallery need the identical
// "click through to the note" behavior, so it was pulled out of this file
