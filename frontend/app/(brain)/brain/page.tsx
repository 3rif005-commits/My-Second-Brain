    ...
    <div className="flex-1 flex items-center justify-center px-8 bg-gray-50/30">
      <div className="text-center max-w-sm">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <ImportFileButton className="inline-flex items-center gap-1.5 text-sm font-semibold px-5 py-2.5 rounded-xl border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-colors">
            Import
          </ImportFileButton>
        </div>
      </div>
